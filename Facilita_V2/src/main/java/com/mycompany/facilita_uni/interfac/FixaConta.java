   ...
   /**
    ...
    private void salvarFixaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarFixaActionPerformed
        try {
            ...
            // Carregar o controlador e catalogo (mesmo processo do console)
            ...
            ContasFixas novaConta = new ContasFixas(valor, data, nome);
            catalogoCF.adicionarContaFixa(novaConta);
