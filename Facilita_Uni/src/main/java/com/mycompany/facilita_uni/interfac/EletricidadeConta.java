...
public class EletricidadeConta extends javax.swing.JFrame {
 ...
 try {
            ...
            int valor, kwh, tempoUso;
            try {
                valor = Integer.parseInt(valorTexto);
                kwh = Integer.parseInt(kwhTexto);
                tempoUso = Integer.parseInt(tempoUsoTexto);
                
                if (valor <= 0 || kwh <= 0 || tempoUso <= 0) {
                    javax.swing.JOptionPane.showMessageDialog(this, 
            ...
            // Criar e adicionar o novo eletrodoméstico
            Eletrodomestico novoEletrodomestico = new Eletrodomestico(nome, kwh, tempoUso);
            usuario.adicionarEletrodomestico(novoEletrodomestico);
            ...
            javax.swing.JOptionPane.showMessageDialog(this, 
                "Conta de eletricidade adicionada com sucesso!\n" +
                "Nome: " + nome + "\n" +
                "Consumo: " + kwh + " kWh\n" +
                "Tempo de uso: " + tempoUso + " horas\n" +
                "Valor: R$ " + valor + "\n" +
                "Vencimento: " + data, 
                "Sucesso", 
