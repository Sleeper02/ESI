...
public class AdicionarEletrodomestico extends javax.swing.JFrame {
    ...
    private void salvarFixaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarFixaActionPerformed
       ...
       try {
            ...
            if (nome.isEmpty() || kwhTexto.isEmpty() || tempoUsoTexto.isEmpty()) {
            ...
            int tempoUso;
            try {
                potencia = Double.parseDouble(kwhTexto);
            ...
            // Converter potência para consumo em kWh (potência * tempo de uso)
            double consumoKwh = potencia * tempoUso;

            // Criar e adicionar o novo eletrodoméstico
            Eletrodomestico novoEletrodomestico = new Eletrodomestico(nome, (int)consumoKwh, tempoUso);
            ...
            javax.swing.JOptionPane.showMessageDialog(this,
                ...
                "Consumo mensal: " + String.format("%.2f", consumoKwh) + " kWh",
                "Sucesso",
